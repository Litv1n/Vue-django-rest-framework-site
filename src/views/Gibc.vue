...
<div class="tm-main-content no-pad-b">
    ...
    <section class="row tm-item-preview">
        <div class="col-md-6 col-sm-12 mb-md-0 mb-5">
            <img src="img/image-05.jpg" alt="Image" class="img-fluid tm-img-center-sm">
        </div>
        <div class="col-md-6 col-sm-12">
            <h2 class="tm-blue-text tm-margin-b-p">Гибкость</h2>
            <p class="tm-margin-b-p">Мы сможем подобрать для вас нужный автомобиль или температурный режим.</p>
            <p class="tm-margin-b-p">Если вам нужно отпраить груз за пределы Московской области наш менеджер поможет вам в этом вопросе.</p>
        </div>
    </section>
