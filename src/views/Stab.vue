...
<div class="tm-main-content no-pad-b">
    ...
    <section class="row tm-item-preview">
        <div class="col-md-6 col-sm-12 mb-md-0 mb-5">
            <img src="img/image-07.jpg" alt="Image" class="img-fluid tm-img-center-sm">
        </div>
        <div class="col-md-6 col-sm-12">
            <h2 class="tm-blue-text tm-margin-b-p">Стабильность</h2>
            <p class="tm-margin-b-p">Уже 5 лет наши грузовики осуществляют перевозки, и у нас нет и не будет причин отказаться от этой деятельности.</p>
        </div>
    </section>
